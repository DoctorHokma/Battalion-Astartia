...
function RetrieveAllMapData() {
	...
	.writeList("Map", getMapString(EditorMap), PrettyList.TYPE.ARRAY)
	.writeList("BiomeMap", getMapString(EditorBiomeMap), PrettyList.TYPE.ARRAY)
	.writeList("ControlMap", getMapString(EditorControlMap), PrettyList.TYPE.ARRAY)
	.writeList("RegionMap", getMapString(EditorRegionMap), PrettyList.TYPE.ARRAY)
	.writeList("Roster", roster, PrettyList.TYPE.ARRAY)
	.openList("Constants", PrettyList.TYPE.OBJECT)
	...
	.closeList()
	.writeList("LocKey", getLocalizationString(), PrettyList.TYPE.ARRAY)

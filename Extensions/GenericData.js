const TERRAIN = [
	{"$name": "TERRAIN_NAME_", "desc": "TERRAIN_DESC_", name: "", passThrough: true, flyThrough: true, sailThrough: false, src:"", traverseFactor:1, protectionFactor:1,Variants:8,Offsets:[0,0,0,0,0,0,0,0]}, 

	//1-5

	{"$name": "TERRAIN_NAME_PLAINS", "desc": "TERRAIN_DESC_PLAINS", name: "Plains", WalkThrough: 1, DriveThrough: 1.2, RollThrough: 1.2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:1, protectionFactor:1,Urbanistics:0,Constructible:true,tag1:"Uneven",tag2:"",tag3:"",tag4:"", Class:"LF",BiomeIndex:1,Variants:8,Offsets:[0,0,0,0,0,0,0,0]},
	{"$name": "TERRAIN_NAME_FOREST", "desc": "TERRAIN_DESC_FOREST", name: "Forest", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:1.5, protectionFactor:0.8,Urbanistics:0,Constructible:true,tag1:"Rugged",tag2:"Concealment",tag3:"",tag4:"", Class:"LF",Variants:4,Offsets:[0,-4,-3,-12],StD:0},
	{"$name": "TERRAIN_NAME_HILLS", "desc": "TERRAIN_DESC_HILLS", name: "Hills", WalkThrough: 1.5, DriveThrough: 1.5, RollThrough: 1.5, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:1.5, protectionFactor:0.8,Urbanistics:0,Constructible:true,tag1:"Rugged",tag2:"Concealment",tag3:"Vantage",tag4:"", Class:"LF",Variants:4,Offsets:[0,0,-4,-5],StD:0},
	{"$name": "TERRAIN_NAME_MOUNTAINS", "desc": "TERRAIN_DESC_MOUNTAINS", name: "Mountains", WalkThrough: 2, DriveThrough: 3, RollThrough: 5, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:0.6,Urbanistics:0,Constructible:false,tag1:"Precipitous",tag2:"Bunker",tag3:"Vantage",tag4:"", Class:"LF",Variants:4,Offsets:[0,-4,-9,-10],StD:-9},	
	{"$name": "TERRAIN_NAME_MEGA_MOUNTAINS", "desc": "TERRAIN_DESC_MEGA_MOUNTAINS", name: "Megamountains", WalkThrough: 5, DriveThrough: 100, RollThrough: 100, FlyThrough: 100, SailThrough: 100, DeepSailThrough:100, WadeThrough:100, protectionFactor:0.4,Urbanistics:0,Constructible:false,tag1:"Impassable",tag2:"",tag3:"",tag4:"", Class:"LF",Variants:2,Offsets:[-21,-21,-21,-21],StD:-21},

	//6-14

	{"$name": "TERRAIN_NAME_ROAD", "desc": "TERRAIN_DESC_ROAD", name: "Road", WalkThrough: 1, DriveThrough: 1, RollThrough: 1, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:1, protectionFactor:1,Urbanistics:1,Constructible:true,tag1:"",tag2:"",tag3:"",tag4:"", Class:"LA"},
	{"$name": "TERRAIN_NAME_RUINS", "desc": "TERRAIN_DESC_RUINS", name: "Ruins", WalkThrough: 2, DriveThrough: 3, RollThrough: 3, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:0.8,Urbanistics:1,Constructible:true,tag1:"Rugged",tag2:"",tag3:"",tag4:"", Class:"LF",Variants:2,Offsets:[-14,-14,-14,-14],StD:-14},
	{"$name": "TERRAIN_NAME_URBAN_DISTRICT", "desc": "TERRAIN_DESC_URBAN_DISTRICT", name: "Urban District", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:0.8,Urbanistics:1,Constructible:true,revenue:0,tag1:"Rugged",tag2:"",tag3:"",tag4:"", Class:"LF",Variants:4,Offsets:[-14,-14,-14,-14],StD:-14},
	{"$name": "TERRAIN_NAME_INDUSTRIAL_DISTRICT", "desc": "TERRAIN_DESC_INDUSTRIAL_DISTRICT", name: "Industrial District", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:1,Urbanistics:2,Constructible:true,revenue:200,tag1:"Fiscal Center",tag2:"",tag3:"",tag4:"", Class:"S", StD:-10},
	{"$name": "TERRAIN_NAME_MILITARY_INDUSTRIAL_COMPLEX", "desc": "TERRAIN_DESC_MILITARY_INDUSTRIAL_COMPLEX", name: "Military-Industrial Complex", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:1,Urbanistics:3,Constructible:false,tag1:"",tag2:"",tag3:"",tag4:"", Class:"S", StD:-8},
	{"$name": "TERRAIN_NAME_AVIATION_INDUSTRIAL_FACILITY", "desc": "TERRAIN_DESC_AVIATION_INDUSTRIAL_FACILITY", name: "Aviation Industrial Facility", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:1,Urbanistics:3,Constructible:false,tag1:"",tag2:"",tag3:"",tag4:"", Class:"S", StD:-14},
	{"$name": "TERRAIN_NAME_SHIPBUILDING_FACILITY", "desc": "TERRAIN_DESC_SHIPBUILDING_FACILITY", name: "Shipbuilding Facility", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:1,Urbanistics:3,Constructible:false,tag1:"",tag2:"",tag3:"",tag4:"", Class:"S", StD:-14},
	{"$name": "TERRAIN_NAME_HEADQUARTERS", "desc": "TERRAIN_DESC_HEADQUARTERS", name: "Headquarters", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:0.5,Urbanistics:4,Constructible:true,revenue:100,tag1:"Financial Center",tag2:"",tag3:"",tag4:"", Class:"S", StD:0},
	{"$name": "TERRAIN_NAME_COMMAND_CENTER", "desc": "TERRAIN_DESC_COMMAND_CENTER", name: "Command Center", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:0.5,Urbanistics:5,Constructible:true,revenue:300,tag1:"Fiduciary Center",tag2:"",tag3:"",tag4:"", Class:"S", StD:-18},

	//15-19

	{"$name": "TERRAIN_NAME_TAIGA", "desc": "TERRAIN_DESC_TAIGA", name: "Taiga", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:0.8,logisticFactor:0.8,Urbanistics:0,Constructible:true,tag1:"Rugged",tag2:"Concealment",tag3:"",tag4:"", Class:"LF",BiomeIndex:3,Variants:4,Offsets:[0,-4,-3,-12]},
	{"$name": "TERRAIN_NAME_DESERT", "desc": "TERRAIN_DESC_DESERT", name: "Desert", WalkThrough: 1, DriveThrough: 1.2, RollThrough: 1.2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:1, protectionFactor:1,logisticFactor:0.8,Urbanistics:0,Constructible:true,tag1:"Uneven",tag2:"",tag3:"",tag4:"", Class:"LF",BiomeIndex:2,Variants:3,Offsets:[0,0,0,0,0,0,0,0]},
	{"$name": "TERRAIN_NAME_TUNDRA", "desc": "TERRAIN_DESC_TUNDRA", name: "Tundra", WalkThrough: 1, DriveThrough: 1.2, RollThrough: 1.2, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:1, protectionFactor:0.8,logisticFactor:0.8,Urbanistics:0,Constructible:true,tag1:"Uneven",tag2:"",tag3:"",tag4:"", Class:"LF",BiomeIndex:3,Variants:8,Offsets:[0,0,0,0,0,0,0,0]},
	{"$name": "TERRAIN_NAME_EXTREME_DESERT", "desc": "TERRAIN_DESC_EXTREME_DESERT", name: "Extreme Desert", WalkThrough: 2, DriveThrough: 5, RollThrough: 3, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:5, protectionFactor:1,logisticFactor:0.6,Urbanistics:0,Constructible:true,tag1:"",tag2:"",tag3:"",tag4:"", Class:"LF",BiomeIndex:4,Variants:3,Offsets:[0,0,0,0,0,0,0,0]},
	{"$name": "TERRAIN_NAME_ARCTIC_HELLHOLE", "desc": "TERRAIN_DESC_ARCTIC_HELLHOLE", name: "Arctic Hellhole", WalkThrough: 2, DriveThrough: 5, RollThrough: 3, FlyThrough: 2, SailThrough: 100, DeepSailThrough:100, WadeThrough:5, protectionFactor:1,logisticFactor:0.6,Urbanistics:0,Constructible:true,tag1:"",tag2:"",tag3:"",tag4:"", Class:"LF",BiomeIndex:5,Variants:8,Offsets:[0,0,0,0,0,0,0,0]},

	//20-21


	{"$name": "TERRAIN_NAME_BRIDGE", "desc": "TERRAIN_DESC_BRIDGE", name: "Bridge", WalkThrough: 1, DriveThrough: 1, RollThrough: 1, FlyThrough: 1, SailThrough: 50, DeepSailThrough:50, WadeThrough:1, protectionFactor:1,Urbanistics:1,Constructible:true,tag1:"",tag2:"",tag3:"",tag4:"", Class:"MC"},
	{"$name": "TERRAIN_NAME_HIGH_BRIDGE", "desc": "TERRAIN_DESC_HIGH_BRIDGE", name: "High Bridge", WalkThrough: 1, DriveThrough: 1, RollThrough: 1, FlyThrough: 1, SailThrough: 1, DeepSailThrough:2, WadeThrough:1, protectionFactor:1,Urbanistics:1,Constructible:true,tag1:"",tag2:"",tag3:"",tag4:"", Class:"MC"},

	//22-30

	{"$name": "TERRAIN_NAME_RIVER", "desc": "TERRAIN_DESC_RIVER", name: "River", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 1, SailThrough: 1, DeepSailThrough:100, WadeThrough:3, protectionFactor:1.4,Urbanistics:0,Constructible:false,tag1:"Shallow",tag2:"",tag3:"",tag4:"", Class:"WA"},
	{"$name": "TERRAIN_NAME_SEA", "desc": "TERRAIN_DESC_SEA", name: "Sea", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 1, SailThrough: 1, DeepSailThrough:1, WadeThrough:100, protectionFactor:1,Urbanistics:0,Constructible:false,tag1:"",tag2:"",tag3:"",tag4:"", Class:"WE"},
	{"$name": "TERRAIN_NAME_REEF", "desc": "TERRAIN_DESC_REEF", name: "Reef", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 1, SailThrough: 1.2, DeepSailThrough:2, WadeThrough:100, protectionFactor:0.8,Urbanistics:0,Constructible:false,tag1:"Tricky Waters",tag2:"Naval Concealment",tag3:"",tag4:"", Class:"WF",Variants:4,Offsets:[0,0,0,0]},
	{"$name": "TERRAIN_NAME_FLOES", "desc": "TERRAIN_DESC_FLOES", name: "Floes", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 1, SailThrough: 2, DeepSailThrough:1.25, WadeThrough:100, protectionFactor:0.8,Urbanistics:0,Constructible:false,tag1:"Tricky Waters",tag2:"Naval Concealment",tag3:"",tag4:"", Class:"WF",Variants:4,Offsets:[0,0,0,0]},
	{"$name": "TERRAIN_NAME_ARCHIPELAGO", "desc": "TERRAIN_DESC_ARCHIPELAGO", name: "Archipelago", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 1, SailThrough: 1.5, DeepSailThrough:2, WadeThrough:100, protectionFactor:0.6,Urbanistics:0,Constructible:false,tag1:"Tricky Waters",tag2:"Naval Concealment",tag3:"",tag4:"", Class:"WF",Variants:4,Offsets:[0,0,0,0]},
	{"$name": "TERRAIN_NAME_ROCK_FORMATION", "desc": "TERRAIN_DESC_ROCK_FORMATION", name: "Rocks", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 1, SailThrough: 1.5, DeepSailThrough:2, WadeThrough:100, protectionFactor:0.6,Urbanistics:0,Constructible:false,tag1:"Bunker",tag2:"Tricky Waters",tag3:"Dangerous",tag4:"", Class:"WF",Variants:4,Offsets:[0,0,0,0]},
	{"$name": "TERRAIN_NAME_ICEBERGS", "desc": "TERRAIN_DESC_ICEBERGS", name: "Icebergs", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 1, SailThrough: 1.5, DeepSailThrough:2, WadeThrough:100, protectionFactor:0.6,Urbanistics:0,Constructible:false,tag1:"Bunker",tag2:"Tricky Waters",tag3:"Dangerous",tag4:"", Class:"WF",Variants:4,Offsets:[0,0,0,0]},
	{"$name": "TERRAIN_NAME_SHORE", "desc": "TERRAIN_DESC_SHORE", name: "Shore", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 2, FlyThrough: 1, SailThrough: 1.5, DeepSailThrough:100, WadeThrough:1.5, protectionFactor:1.2,Urbanistics:0,Constructible:true,tag1:"Shallow",tag2:"Uneven",tag3:"",tag4:"", Class:"B"},
	{"$name": "TERRAIN_NAME_OIL_RIG", "desc": "TERRAIN_DESC_OIL_RIG", name: "Oil Rig", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 1, SailThrough: 1, DeepSailThrough:1, WadeThrough:100, protectionFactor:1,Urbanistics:2,Constructible:false,revenue:200,tag1:"Fiscal Center",tag2:"",tag3:"",tag4:"", Class:"WS", StD:-9},

	//31-40
	{"$name": "TERRAIN_NAME_MARSHLAND", "desc": "TERRAIN_DESC_MARSHLAND", name: "Marsh", WalkThrough: 1.5, DriveThrough: 2, RollThrough: 3, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:1.2, protectionFactor:0.8,Urbanistics:0,Constructible:false,tag1:"Rugged",tag2:"Concealment",tag3:"",tag4:"", Class:"LF",Variants:3,Offsets:[0,0,0]},
	{"$name": "TERRAIN_NAME_VOLCANO", "desc": "TERRAIN_DESC_VOLCANO", name: "Volcano", WalkThrough: 3, DriveThrough: 4, RollThrough: 5, FlyThrough: 2, SailThrough: 100, DeepSailThrough:100, WadeThrough:3, protectionFactor:0.6,Urbanistics:0,Constructible:false,tag1:"Precipitous",tag2:"Vantage",tag3:"Bunker",tag4:"", Class:"LF",Variants:1,Offsets:[-8],StD:-8},
	{"$name": "TERRAIN_NAME_MOON", "desc": "TERRAIN_DESC_MOON", name: "Moon", WalkThrough: 2, DriveThrough: 2, RollThrough: 1.5, FlyThrough: 2, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:0.9,Urbanistics:0,Constructible:true,tag1:"Uneven",tag2:"Rugged",tag3:"",tag4:"", Class:"LF",BiomeIndex:6,Variants:4,Offsets:[0,0,0,0]},
	{"$name": "TERRAIN_NAME_MARS", "desc": "TERRAIN_DESC_MARS", name: "Mars", WalkThrough: 2, DriveThrough: 2, RollThrough: 1.5, FlyThrough: 2, SailThrough: 100, DeepSailThrough:100, WadeThrough:2, protectionFactor:0.9,Urbanistics:0,Constructible:true,tag1:"Uneven",tag2:"Rugged",tag3:"",tag4:"", Class:"LF",BiomeIndex:7,Variants:4,Offsets:[0,0,0,0]},
	{"$name": "TERRAIN_NAME_COSMOS", "desc": "TERRAIN_DESC_COSMOS", name: "Cosmos", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 4, SailThrough: 100, DeepSailThrough:100, WadeThrough:100, protectionFactor:1,Urbanistics:0,Constructible:false,tag1:"",tag2:"",tag3:"",tag4:"", Class:"WA",Variants:8,Offsets:[0,0,0,0,0,0,0,0]},
	//{"$name": "TERRAIN_NAME_", "desc": "TERRAIN_DESC_", name: "Landmines", WalkThrough: 3, DriveThrough: 4, RollThrough: 5, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:3, protectionFactor:0.6,Urbanistics:0,Constructible:false,tag1:"Rugged",tag2:"Concealment",tag3:"",tag4:"", Class:"LF",Variants:4,Offsets:[0,0,0,0]},
	//{"$name": "TERRAIN_NAME_", "desc": "TERRAIN_DESC_", name: "Naval Mines", WalkThrough: 3, DriveThrough: 4, RollThrough: 5, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:3, protectionFactor:0.6,Urbanistics:0,Constructible:false,tag1:"Rugged",tag2:"Concealment",tag3:"",tag4:"", Class:"LF",Variants:4,Offsets:[0,0,0,0]},
	//{"$name": "TERRAIN_NAME_", "desc": "TERRAIN_DESC_", name: "Railway", WalkThrough: 0.3, DriveThrough: 0.6, RollThrough: 0.5, FlyThrough: 1, SailThrough: 100, DeepSailThrough:100, WadeThrough:0.4, protectionFactor:1,Urbanistics:1,Constructible:true,tag1:"",tag2:"",tag3:"",tag4:"", Class:"LA"},
	//{"$name": "TERRAIN_NAME_", "desc": "TERRAIN_DESC_", name: "Canyon"},
	//{"$name": "TERRAIN_NAME_", "desc": "TERRAIN_DESC_", name: ""},
	//{"$name": "TERRAIN_NAME_", "desc": "TERRAIN_DESC_", name: "RiverSource", WalkThrough: 100, DriveThrough: 100, RollThrough: 100, FlyThrough: 1, SailThrough: 1, DeepSailThrough:100, WadeThrough:2, protectionFactor:100,Urbanistics:0,tag1:"",tag2:"",tag3:"",tag4:""},
];

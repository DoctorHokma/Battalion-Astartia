...
const TRAITS = {
	"Uneven": { "name": "TRAIT_NAME_UNEVEN", "desc": "TRAIT_DESC_UNEVEN" },
	"Rugged": { "name": "TRAIT_NAME_RUGGED", "desc": "TRAIT_DESC_RUGGED" },
	"Precipitous": { "name": "TRAIT_NAME_PRECIPITOUS", "desc": "TRAIT_DESC_PRECIPITOUS" },
	"Impassable": { "name": "TRAIT_NAME_IMPASSABLE", "desc": "TRAIT_DESC_IMPASSABLE" },
	"Tricky Waters": { "name": "TRAIT_NAME_TRICKY_WATERS", "desc": "TRAIT_DESC_TRICKY_WATERS" },
	"Concealment": { "name": "TRAIT_NAME_CONCEALMENT", "desc": "TRAIT_DESC_CONCEALMENT" },
	"Naval Concealment": { "name": "TRAIT_NAME_NAVAL_CONCEALMENT", "desc": "TRAIT_DESC_NAVAL_CONCEALMENT" },
	"Bunker": { "name": "TRAIT_NAME_BUNKER", "desc": "TRAIT_DESC_BUNKER" },
	"Shallow": { "name": "TRAIT_NAME_SHALLOW", "desc": "TRAIT_DESC_SHALLOW" },
	"Vantage": { "name": "TRAIT_NAME_VANTAGE", "desc": "TRAIT_DESC_VANTAGE" },
	"Dangerous": { "name": "TRAIT_NAME_DANGEROUS", "desc": "TRAIT_DESC_DANGEROUS" },
	"Logistic Challenge": { "name": "TRAIT_NAME_LOGISTIC_CHALLENGE", "desc": "TRAIT_DESC_LOGISTIC_CHALLENGE" },
	"Logistic Nightmare": { "name": "TRAIT_NAME_LOGISTIC_NIGHTMARE", "desc": "TRAIT_DESC_LOGISTIC_NIGHTMARE" },
	"Financial Center": { "name": "TRAIT_NAME_FINANCIAL_CENTER", "desc": "TRAIT_DESC_FINANCIAL_CENTER" },
	"Fiscal Center": { "name": "TRAIT_NAME_FISCAL_CENTER", "desc": "TRAIT_DESC_FISCAL_CENTER" },
	"Fiduciary Center": { "name": "TRAIT_NAME_FIDUCIARY_CENTER", "desc": "TRAIT_DESC_FIDUCIARY_CENTER" },
	"Conqueror": { "name": "TRAIT_NAME_CONQUEROR", "desc": "TRAIT_DESC_CONQUEROR" },
	"Skysweeper": { "name": "TRAIT_NAME_SKYSWEEPER", "desc": "TRAIT_DESC_SKYSWEEPER" },
	"Depth Charge": { "name": "TRAIT_NAME_DEPTH_CHARGE", "desc": "TRAIT_DESC_DEPTH_CHARGE" },
	"Sonar": { "name": "TRAIT_NAME_SONAR", "desc": "TRAIT_DESC_SONAR" },
	"Radar": { "name": "TRAIT_NAME_RADAR", "desc": "TRAIT_DESC_RADAR" },
	"Anti-Infantry": { "name": "TRAIT_NAME_ANTI_INFANTRY", "desc": "TRAIT_DESC_ANTI_INFANTRY" },
	"Anti-Tank": { "name": "TRAIT_NAME_ANTI_TANK", "desc": "TRAIT_DESC_ANTI_TANK" },
	"Anti-Air": { "name": "TRAIT_NAME_ANTI_AIR", "desc": "TRAIT_DESC_ANTI_AIR" },
	"Anti-Ship": { "name": "TRAIT_NAME_ANTI_SHIP", "desc": "TRAIT_DESC_ANTI_SHIP" },
	"Anti-Structure": { "name": "TRAIT_NAME_ANTI_STRUCTURE", "desc": "TRAIT_DESC_ANTI_STRUCTURE" },
	"Stealth": { "name": "TRAIT_NAME_STEALTH", "desc": "TRAIT_DESC_STEALTH" },
	"Submerged": { "name": "TRAIT_NAME_SUBMERGED", "desc": "TRAIT_DESC_SUBMERGED" },
	"Commando": { "name": "TRAIT_NAME_COMMANDO", "desc": "TRAIT_DESC_COMMANDO" },
	"Crab": { "name": "TRAIT_NAME_CRAB", "desc": "TRAIT_DESC_CRAB" },
	"Steer": { "name": "TRAIT_NAME_STEER", "desc": "TRAIT_DESC_STEER" },
	"Indomitable": { "name": "TRAIT_NAME_INDOMITABLE", "desc": "TRAIT_DESC_INDOMITABLE" },
	"Schwerpunkt": { "name": "TRAIT_NAME_SCHWERPUNKT", "desc": "TRAIT_DESC_SCHWERPUNKT" },
	"Bewegungskrieg": { "name": "TRAIT_NAME_BEWEGUNGSKRIEG", "desc": "TRAIT_DESC_BEWEGUNGSKRIEG" },
	"Mobile Battery": { "name": "TRAIT_NAME_MOBILE_BATTERY", "desc": "TRAIT_DESC_MOBILE_BATTERY" },
	"Streamlined": { "name": "TRAIT_NAME_STREAMLINED", "desc": "TRAIT_DESC_STREAMLINED" },
	"Cemented Steel Armor": { "name": "TRAIT_NAME_CEMENTED_STEEL_ARMOR", "desc": "TRAIT_DESC_CEMENTED_STEEL_ARMOR" },
	"Cavitation Explosion": { "name": "TRAIT_NAME_CAVITATION_EXPLOSION", "desc": "TRAIT_DESC_CAVITATION_EXPLOSION" },
	"Seabound": { "name": "TRAIT_NAME_SEABOUND", "desc": "TRAIT_DESC_SEABOUND" },
	"Self-Destruct": { "name": "TRAIT_NAME_SELF_DESTRUCT", "desc": "TRAIT_DESC_SELF_DESTRUCT" },
	"Dispersion": { "name": "TRAIT_NAME_DISPERSION", "desc": "TRAIT_DESC_DISPERSION" },
	"JUDGEMENT": { "name": "TRAIT_NAME_JUDGEMENT", "desc": "TRAIT_DESC_JUDGEMENT" },
	"Supply Distribution": { "name": "TRAIT_NAME_SUPPLY_DISTRIBUTION", "desc": "TRAIT_DESC_SUPPLY_DISTRIBUTION" },
	"Inertial": { "name": "TRAIT_NAME_INERTIAL", "desc": "TRAIT_DESC_INERTIAL" },
	"Streamblast": { "name": "TRAIT_NAME_STREAMBLAST", "desc": "TRAIT_DESC_STREAMBLAST" },
	"Airborne": { "name": "TRAIT_NAME_AIRBORNE", "desc": "TRAIT_DESC_AIRBORNE" },
	"Heroic": { "name": "TRAIT_NAME_HEROIC", "desc": "TRAIT_DESC_HEROIC" },
	"Tank-Hunter": { "name": "TRAIT_NAME_TANK_HUNTER", "desc": "TRAIT_DESC_TANK_HUNTER" },
	"Naval Transport": { "name": "TRAIT_NAME_NAVAL_TRANSPORT", "desc": "TRAIT_DESC_NAVAL_TRANSPORT" },
	"Air Transport": { "name": "TRAIT_NAME_AIR_TRANSPORT", "desc": "TRAIT_DESC_AIR_TRANSPORT" },
	"Unbuilt": { "name": "TRAIT_NAME_UNBUILT", "desc": "TRAIT_DESC_UNBUILT" },
	"Tank Pooper": { "name": "TRAIT_NAME_TANK_POOPER", "desc": "TRAIT_DESC_TANK_POOPER" },
	"Absorber": { "name": "TRAIT_NAME_ABSORBER", "desc": "TRAIT_DESC_ABSORBER" },
	"Terrifying": { "name": "TRAIT_NAME_TERRIFYING", "desc": "TRAIT_DESC_TERRIFYING" },
	"Lynchpin": { "name": "TRAIT_NAME_LYNCHPIN", "desc": "TRAIT_DESC_LYNCHPIN" },
	"Inflaming": { "name": "TRAIT_NAME_INFLAMING", "desc": "TRAIT_DESC_INFLAMING" }
};

const LANGUAGE_ENGLISH = {
	...
	"SYSTEM_TUTORIAL_NAME": "Name",
	"SYSTEM_TUTORIAL_DESC": "Description",
	...
	"CODEX_BUTTON_SPECIAL_UNITS": "Special Infantry",
	"CODEX_BUTTON_SPECIAL_ARMOR": "Special Tanks",
	"CODEX_BUTTON_SPECIAL_AIRCRAFT": "Special Planes",
	"CODEX_BUTTON_SPECIAL_SHIPS": "Special Ships",
	"CODEX_BUTTON_THIS_WORLD": "This World",
	"CODEX_BUTTON_IT_HAPPENED": "It Happened",
	"CODEX_BUTTON_OPERATION_TZIMTZUM": "Operation TZIMTZUM",
	"CODEX_BUTTON_OPERATION_GOLCHAB": "Operation GOLCHAB",
	"CODEX_BUTTON_OPERATION_GHAAG_SHEBLAH": "Operation GHAAG SHEBLAH",
	"CODEX_BUTTON_OPERATION_OHR_EIN_ZOF": "Operation OHR EIN ZOF",
	"CODEX_BUTTON_OPERATION_SAMSON": "Operation SAMSON",
	"CODEX_BUTTON_OPERATION_THAUMIEL": "Operation THAUMIEL",
	"CODEX_BUTTON_WAR_PLAN_ARMAGEDDON": "ARMAGEDDON",
    ...
    "TERRAIN_NAME_MOUNTAINS": "Mountain",
    "TERRAIN_NAME_MEGA_MOUNTAINS": "Megamountains",
    "TERRAIN_NAME_ROAD": "Road",
    "TERRAIN_NAME_RUINS": "Ruins",
    "TERRAIN_NAME_URBAN_DISTRICT": "Urban District",
    "TERRAIN_NAME_INDUSTRIAL_DISTRICT": "Industrial District",
    "TERRAIN_NAME_MILITARY_INDUSTRIAL_COMPLEX": "Military-Industrial Complex",
    "TERRAIN_NAME_AVIATION_INDUSTRIAL_FACILITY": "Aviation Industrial Facility",
    "TERRAIN_NAME_SHIPBUILDING_FACILITY": "Shipbuilding Facility",
    "TERRAIN_NAME_HEADQUARTERS": "Headquarters",
    "TERRAIN_NAME_COMMAND_CENTER": "Command Center",
    "TERRAIN_NAME_TAIGA": "Taiga",
    "TERRAIN_NAME_DESERT": "Desert",
    "TERRAIN_NAME_TUNDRA": "Tundra",
    "TERRAIN_NAME_EXTREME_DESERT": "Extreme Desert",
    "TERRAIN_NAME_ARCTIC_HELLHOLE": "Arctic Hellhole",
    "TERRAIN_NAME_BRIDGE": "Bridge",
    "TERRAIN_NAME_HIGH_BRIDGE": "High Bridge",
    "TERRAIN_NAME_RIVER": "River",
    "TERRAIN_NAME_SEA": "Sea",
    "TERRAIN_NAME_REEF": "Reef",
    "TERRAIN_NAME_FLOES": "Floes",
    "TERRAIN_NAME_ARCHIPELAGO": "Archipelago",
    "TERRAIN_NAME_ROCK_FORMATION": "Rock Formation",
    "TERRAIN_NAME_ICEBERGS": "Icebergs",
    "TERRAIN_NAME_SHORE": "Shore",
    "TERRAIN_NAME_OIL_RIG": "Oil Rig",
    "TERRAIN_NAME_MARSHLAND": "Marshland",
    "TERRAIN_NAME_VOLCANO": "Volcano",
    "TERRAIN_NAME_MINEFIELD": "Minefield",
    "TERRAIN_NAME_NAVAL_MINES": "Naval Mines",
    "TERRAIN_NAME_RAILWAYS": "Railways",
    "TERRAIN_NAME_MOON": "",
    "TERRAIN_NAME_MARS": "",
    "TERRAIN_NAME_COSMOS": "",

    "TERRAIN_DESC_PLAINS": "Plains are easy to cross, perfect for mobile warfare, but offer no defensive at all.",
    "TERRAIN_DESC_FOREST": "Forests are difficult to cross but offer good cover from attacks",
    "TERRAIN_DESC_HILLS": "Hills offer high ground for ranged units and defensive cover in general",
    "TERRAIN_DESC_MOUNTAINS": "Mountains cannot be crossed by some units, but offer great defensive bonuses",
    "TERRAIN_DESC_MEGA_MOUNTAINS": "So massive that their turbulence even prevents aircraft from flying overhead. Nothing can pass through these",
    "TERRAIN_DESC_ROAD": "Roads are extremely easy to cross, perfect for deploying heavy armor. Well, theoretically. Pity on whomever has to do their maintenance after that.",
    "TERRAIN_DESC_RUINS": "Difficult to cross, partially due to partisan resistance.",
    "TERRAIN_DESC_URBAN_DISTRICT": "Horrible terrain to fight in, try taking this quickly or bypassing it.",
    "TERRAIN_DESC_INDUSTRIAL_DISTRICT": "Controlling it generates material income for your war effort.",
    "TERRAIN_DESC_MILITARY_INDUSTRIAL_COMPLEX": "Variety of factories and plants capable of producing military materiel.",
    "TERRAIN_DESC_AVIATION_INDUSTRIAL_FACILITY": "Factories with lathes and tools geared towards combat aircraft production.",
    "TERRAIN_DESC_SHIPBUILDING_FACILITY": "Specialized in laying keels and turning them into warships. Not capable of building Tillmans though.",
    "TERRAIN_DESC_HEADQUARTERS": "Lynchpin of regional authority and command.",
    "TERRAIN_DESC_COMMAND_CENTER": "Supreme Center of Command and Coordination. Capturing this means a critical strike to the opponent.",
    "TERRAIN_DESC_TAIGA": "The silent taiga is hostile to everyone except her sons.",
    "TERRAIN_DESC_DESERT": "Leagues and leagues of nothing but sun and sand.",
    "TERRAIN_DESC_TUNDRA": "Permafrost and lack of vegetation makes this area a logistic headache.",
    "TERRAIN_DESC_EXTREME_DESERT": "Burning-hot expanse of residual salt, not only it hides sinkhole traps but even breathing the air for too long is toxic.",
    "TERRAIN_DESC_ARCTIC_HELLHOLE": "A sea of frequent blizzards, blinding white ice, bone-biting cold and the severe risk of hypothermia.",
    "TERRAIN_DESC_BRIDGE": "Bridges link up landmasses, allowing ground units passage.",
    "TERRAIN_DESC_HIGH_BRIDGE": "High bridges can both be crossed over by ground units, and sailed under by ships.",
    "TERRAIN_DESC_RIVER": "A relatively narrow body of flowing water, and the bane of every invader in history.",
    "TERRAIN_DESC_SEA": "This is water. Fish sail on it and ships swim in it. Can you drink it? No. Why? Because you're not a fish.",
    "TERRAIN_DESC_REEF": "Rocks or corals that almost reach the sea surface, making it hard to sail through. Schettino, stay the fuck away from it!",
    "TERRAIN_DESC_FLOES": "Fragments of ice sheets slowly drifting. Tricky to cross for ships without a sturdy keel or submerging hull.",
    "TERRAIN_DESC_ARCHIPELAGO": "A bunch of islands that offer cover but are tricky to cross",
    "TERRAIN_DESC_ROCK_FORMATION": "Clusters of dangerous rocks that cause accidents when sailed through",
    "TERRAIN_DESC_ICEBERGS": "Barely floating but deceptively dangerous bodies of ice that must be carefully sailed around.",
    "TERRAIN_DESC_SHORE": "The edge where the sea meets the ground. Can be crossed both by land units and by ships whose rudder is high enough",
    "TERRAIN_DESC_OIL_RIG": "Strategic asset, controlling this earns you resources every turn. ",
    "TERRAIN_DESC_MARSHLAND": "If the stench doesn't kill you, the mosquitoes will",
    "TERRAIN_DESC_VOLCANO": "Impassable to all but air units",
    "TERRAIN_DESC_MINEFIELD": "Units who step on this take damage",
    "TERRAIN_DESC_NAVAL_MINES": "Ships who step on this take damage",
    "TERRAIN_DESC_RAILWAYS": "Quickly transports land units across the map",
    "TERRAIN_DESC_MOON": "",
    "TERRAIN_DESC_MARS": "",
    "TERRAIN_DESC_COSMOS": "",
	...
	"TUTORIAL_LEVEL_BUTTON_3": "Mission 3",
	"TUTORIAL_LEVEL_BUTTON_4": "Mission 4",
	"TUTORIAL_LEVEL_BUTTON_5": "Mission 5",
	"TUTORIAL_LEVEL_BUTTON_6": "Mission 6",
	"TUTORIAL_LEVEL_BUTTON_7": "Mission 7",
	"TUTORIAL_LEVEL_BUTTON_8": "Mission 8",
	"TUTORIAL_LEVEL_BUTTON_9": "Mission 9",
	"TUTORIAL_LEVEL_BUTTON_10": "Mission 10",

	"TUTORIAL_LEVEL_NAME_1": "The Basics of Tactical Command",
	"TUTORIAL_LEVEL_NAME_2": "Tactical Exercise",
	"TUTORIAL_LEVEL_NAME_3": "Terrain Exercise",
	"TUTORIAL_LEVEL_NAME_4": "Logistical Exercise",
	"TUTORIAL_LEVEL_NAME_5": "Industrial Exercise",
	"TUTORIAL_LEVEL_NAME_6": "Transport Exercise",
	"TUTORIAL_LEVEL_NAME_7": "Mixed Exercise",
	"TUTORIAL_LEVEL_NAME_8": "Cooperation Exercise",
	"TUTORIAL_LEVEL_NAME_9": "Combined Arms Exercise",
	"TUTORIAL_LEVEL_NAME_10": "Final Exercise",

	"TUTORIAL_LEVEL_DESC_1": "In this first lesson, you will learn the very basics. How to select units, move them and attack",
	"TUTORIAL_LEVEL_DESC_2": "This battle will give you a chance to practice what you learned in the last one",
	"TUTORIAL_LEVEL_DESC_3": "Oftentimes, terrain makes the difference. You will learn the importance of defensible ground and of impassable terrain.",
	"TUTORIAL_LEVEL_DESC_4": "The side with superior logistics has a clear advantage. Here, you will learn to use that in your favor",
	"TUTORIAL_LEVEL_DESC_5": "It doesn't take a genius to know that oftentimes you need to make more units in order to win. Take this as a cute level where you can try all units out",
	"TUTORIAL_LEVEL_DESC_6": "Practice transporting units via air or ship in order to know how to carry out a paradrop or an amphibious landing later on",
	"TUTORIAL_LEVEL_DESC_7": "Let us get you used to the special mechanics of certain units. Splash attack, sneak attack, interception, healing units and so on",
	"TUTORIAL_LEVEL_DESC_8": "Because one needs to learn how to deal with having to cooperate with their allies. Hopefully you won't have to though; the AI still sucks",
	"TUTORIAL_LEVEL_DESC_9": "Land, sea, air, structures. Contact, ranged, burst. So many types of firepower that you must learn to syncronise to perfect unison",
	"TUTORIAL_LEVEL_DESC_10": "You have learned the basics of what you need to know to win in this game. The time has come to see how much you actually understood. This is your final exam.",

	"SPECIAL_LEVELS_BUTTON_EXPANSION": "Plot Expansion",
	"SPECIAL_LEVELS_BUTTON_SKIRMISHES": "Skirmishes",
	"SPECIAL_LEVELS_BUTTON_CUTE": "Cute Levels",
	"SPECIAL_LEVELS_BUTTON_HISTORICAL": "Historical Battles",
	"SPECIAL_LEVELS_BUTTON_HONOUR": "Tribute Levels",
	"SPECIAL_LEVELS_BUTTON_CHALLENGES": "Challenges",
	"SPECIAL_LEVELS_BUTTON_MEMES": "Meme Levels",
	"SPECIAL_LEVELS_BUTTON_ANIME": "Anime Levels",
	"SPECIAL_LEVELS_BUTTON_GRAND": "Gigamaps",

	"SPECIAL_LEVELS_NAME_EXPANSION": "Plot Expansion",
	"SPECIAL_LEVELS_NAME_SKIRMISHES": "Skirmishes",
	"SPECIAL_LEVELS_NAME_CUTE": "Cute Levels",
	"SPECIAL_LEVELS_NAME_HISTORICAL": "Historical Battles",
	"SPECIAL_LEVELS_NAME_HONOUR": "Tribute Levels",
	"SPECIAL_LEVELS_NAME_CHALLENGES": "Challenges",
	"SPECIAL_LEVELS_NAME_MEMES": "Meme Levels",
	"SPECIAL_LEVELS_NAME_ANIME": "Anime Levels",
	"SPECIAL_LEVELS_NAME_GRAND": "Gigamaps",

	"SPECIAL_LEVELS_DESC_EXPANSION": "Plot Expansion",
	"SPECIAL_LEVELS_DESC_SKIRMISHES": "Skirmishes",
	"SPECIAL_LEVELS_DESC_CUTE": "Cute Levels",
	"SPECIAL_LEVELS_DESC_HISTORICAL": "Historical Battles",
	"SPECIAL_LEVELS_DESC_HONOUR": "Tribute Levels",
	"SPECIAL_LEVELS_DESC_CHALLENGES": "Challenges",
	"SPECIAL_LEVELS_DESC_MEMES": "Meme Levels",
	"SPECIAL_LEVELS_DESC_ANIME": "Anime Levels",
	"SPECIAL_LEVELS_DESC_GRAND": "Gigamaps",

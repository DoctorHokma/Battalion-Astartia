const LANGUAGE_ROMANIAN = {
	...
	"TOOLTIP_1": "Luptă în Marele Război Astartian, cu orice țară alegi",
	"TOOLTIP_2": "Învață să joci în câteva misiuni simple",
	"TOOLTIP_3": "Continuă ultimul nivel pe care îl jucai",
	"TOOLTIP_4": "Adjustează sunetul, muzica și altele",
	"TOOLTIP_5": "Mulțumiri speciale tuturor celor care ne-au ajutat să facem asta!",
	"TOOLTIP_6": "Construiește-ți propriile nivele și joacă",
	"TOOLTIP_7": "Citește despre Astartia și lumea de aici",
	"TOOLTIP_8": "Joacă o multitudine de nivele speciale",
	"TOOLTIP_9": "Alege o națiune și încearcă să cucerești continentul(sau măcar să supraviețuiești)",
	"TOOLTIP_10": "Campania clasică, în care Somertin și Transkal luptă împotriva Kargiei, Polaziei și Elamului. 195 de misiuni în 10 campanii",
	"TOOLTIP_11": "Luptă pentru Maharlika, Nusantara, Gyros sau alte state într-o serie de minicampanii. 25 de misiuni în 5 campanii",
	"TOOLTIP_12": "Un război aprig și necruțător peste scrumul și ruinele Astartiei; brutalizată și pângărită de inrobirea kargiților. 25 de misiuni",
	"TOOLTIP_13": "Alege capitolul",
	"TOOLTIP_14": "Alege misiunea",
	"TOOLTIP_15": "Alege dificultatea",
	"TOOLTIP_16": "Joacă misiunea asta cu prieteni pe același device",
	"TOOLTIP_17": "Aici poți vedea dacă misiunea are obiective sau trăsături speciale",
	"TOOLTIP_18": "Alege un teren. Ține Shift apăsat ca să pictezi repede cu el. Clic-dreapta ca să umpli ecranul cu el.",
	"TOOLTIP_19": "Alege o unitate. Apasă butoanele laterale ca să vezi altă categorie de unități",
	"TOOLTIP_20": "Alege cărei țări îi va aparține următoarea unitate",
	"TOOLTIP_21": "Modifică parametrii nivelului cum ar fi ce teren trebuie apărat, capturat, etc",
	"TOOLTIP_22": "Modifică parametrii sau proprietățile unei unități(nume, descriere, moral, etc)",
	"TOOLTIP_23": "Cum ai găsit asta!? Marș de-aici! Dispari! >:(",
	"TOOLTIP_24": "Pornește/oprește muzica de fundal. Poate ți-a dat traume psihologice sau cancer rectal, nu stiu",
	"TOOLTIP_25": "Pornește/oprește sunetele. Deși nu ar trebui să joci jocuri video la școală, nush",
	"TOOLTIP_26": "Pornește/oprește dialogurile personajelor. Deși avem buton de skip pt asta dacă chiar nu-ți place să citești",
	"TOOLTIP_27": "Pornește/oprește animațiile inerte. Unora nu le plac tancurile tremurăcioase",
	"TOOLTIP_28": "La ce e bun acest buton? :)",
	"TOOLTIP_29": "Cât de mare e documentul ăsta"
};

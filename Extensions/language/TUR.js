TUR={	LanguageComment:"Traducere partiala",
	...
	UnitNames:["İnşaat Alanı",
		"Hafif Piyade","Piyade","Taaruz Piyadesi","Transkalite Keskin Nişancıları","Polesian Sualtı Komandoları","Fırtına Birlikleri","Özel Kuvvetler","Beyaz Muhafızlar","","",
		"Cavalry","Motorlu Piyade","Malzeme Kamyonu","Flak Tankı","Yengeç Tankı","SCADP","Trosky Savaş Makinesi","","","",
		"Hamam böceği Tankı","Şimşek Tankı","Asekara Tankı","Görlitz Tankı","Tank imha edici","AMPAC","Koschei Tankı","Imperterritus Tankı","","",
		"Obüs Bataryası","Trablek Bataryası","Cehennem Bataryası","SPAB","Roket Tankı","400 mm Büyük Bertha.","Pula SRBMDP", "AYIN","","",
		"Stork Taşımacılık","Pelikan Taşımacılık Helikopteri","Şahin Savaş Uçağı","Kartal Savaş Uçağı","Condor Bombardıman Uçağı","Akontio Torpido Filosu","Zeus Stormlord", "","","","ALEPH",
		"Barge Konvoyu","Yiğit", "Denizaltı", "Muhrip", "Hafif Kruvazör","Ağır Kruvazör","Hattıharp gemisi","Uçak gemisi","","", 
		"Barikat","Sığınak","Taret","Uçaksavar kulesi","Kıyı topu","Radar/Sonar İstasyonu","Füze Silosu","Malzeme Deposu","",""
		],	

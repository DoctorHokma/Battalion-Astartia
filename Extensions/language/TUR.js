...
TUR={
	...
	UnitDesc:[	"Burada Barikat inşa ediliyor.",

		"Az donanımlı ve neredeyse eğitimsiz olan bu askerler, savaş için en iyiler değiller, ancak kolayca üretebilirler.",
		"Her ordunun omurgası. Güvenilir, dayanıklı ve en önemlisi, ucuz",
		"İyi eğitimli, iyi donanımlı ve komutanlığınıza hazır.",
		"Transkal'ın zorlu taiga bölgelerinde yetişen bu askerler hayatta kalmak için avlanmak zorunda kaldı. Engebeli arazide çok iyiler.",
		"Plajları veya nehirleri hızla saldırmak ve ele geçirmek için eğitilmişler. Su üzerinde ve karada savaşabilirler.",
		"Akkad Savaşı'nın iyi eğitimli olan ve uzun menzilli silahlarla donatılmış kahramanları.",
		"Bu askerler, düşman hatlarını sızmak ve altyapılarını sabotaj etmek için eğitimli.",
		"En acımasız eğitim ve eğitimi geçiren bu askerler, vatanları için Dünden hazır.",
		"",
		"",
		

		"Bin yıllar boyunca, savaşta alçakgönüllü süvari hala savaş rolünden çıkmadı.",
		"Normal piyadelerden çok daha hızlı olan bu birimler, hızlı bir şekilde birçok yapıyı işgal etmek isterseniz ideal bir seçim.",
		"Herhangi bir şüpheye yer bırakmayacak şekilde, lojistik savaşları kazandırır. Bu küçük şey, yetenekli bir komutanın elinde aldatıcı bir şekilde korkutucudur.",
		"Düşman hava üstünlüğünü engellemek için uyarlanmış olan Flak Tank, uçaklara karşı çok etkili.",
		"Yengeç, suyla bile durdurulamaz. Hem su hem de karada savaşabilir (bilinen nedenlerden dolayı)",
		"Bu harika silah, düşman piyadelerine KORKUNÇ acılar yaşatır.",
		"Bu mühendislik harikası, hareket halindeyken birim üretebilir.",
		"",
		"",
		"",
		

		"Düşmanı iyice sinirlendirmek için büyük ölçüde üretilebilen sinir bozucu bir yaratık.",
		"Hızlı ancak kırılgan, bu birim hızlı saldırılar için uygundurç",
		"Standartlaştırılmış, kolay üretilebilen ve kolay konuşlandırılabilen Asekara Tank, fiyat-performans bakımından en iyi zırhlı araçtır.",
		"Gorlitz Tank güçlü olmasına rağmen eksikliklerle dolu. ",
		"Düşman tanklarını etkili bir şekilde yok etmek için akıllıca tasarlanmış ve karşılığında yok edilmesi zor.",
		"Elam, büyük tanklar yapma konusunda yetersiz olduğundan, onları engebeli arazide harekât için özelleştirdi.",
		"TKargit mühendisliğinin ve Blitzkrieg doktrininin doruk noktası,Wehraboo'nun ıslak hayali.",
		"Imperterritus, yüzleşmek için dehşet verici ve bir o kadar da dayanıklıdır",
		"",
		"",
		
		"Cephane hattı sağlam olduğu sürece, topçular savaşların kralı olacaktır.",
		"Çeşitlilik gözetilerek tasarlanmıştır, hem AA hem de HE mermileriyle uyumludur",
		"Piyadelerin korkulu ruyası. topçu ateşinden kaçabilme yeteneğine sahip.",
		"Pahalı bir askeri donanım parçası. Kağıt üzerinde etkileyici olsa da, sadece bazı durumlarda işe yarıyor.",
		"bir dönemde, Astartian ulusları önüne gelen her araç tipine füze bağlama deneyleri yapıyordu.",
		"HADİ GELİN OROSPU ÇOÇUKLARI!",
		"Üstünlüğünüzü kanıtlamanın yolu, daha büyük bir cinsel organa sahip olmaktan geçmez.Bu devasa uçan dildolar güzel bir örnek.",
		"Son derece gelişmiş bir teknoloji; nötron akışını öne doğru ateşleyerek düşmanları radyasyona maruz bırakır. Kullanımı muhtemelen bir on yıl kadar yasal olacak.",
		"",
		"",
		
		"Dikkate değer bir mühendislik örneği, bazı birimleri havayla taşıyabilme kapasitesine sahip.",
		"Bizim bir işimiz var. Yeni askerleri savaş alanına uçurup yaralı adamları geri getirmek.",
		"Hızlı ve öfkeli, diğer düşman uçaklarını avlamada uzman.",
		"Kara birimlerini süründürmek için özel olarak yapılmıştır.",
		"Eğer Kartal Savaş Uçağının yeterince 'dakka' taşımadığını hissettiğinizde kullanın",
		"Kavitasyon prensibine göre, bu uçak Azur Lane oyuncularından daha sert şekilde gemileri siker.",
		"Avant-garde teknoloji, diğer uçaklardan çok daha üstün hava muharebesi ve bombardıman sonuçları elde eder.",
		"",
		"",
		"",

		"Birimleri taşımak için tasarlanmış tek bir amaçlı bir barje.",
		"Gemi yapımı ve petrol kuyuları gibi binaları ele geçirebilme yeteneğine sahiptir. Petrol mü o?",
		"Genel kanının aksine, büyük gemilere ekstra hasar vermez.",
		"Ucuz, güvenilir ve çok yönlü bir gemi.",
		"Twıtter kullanıcısı.  Elinden her iş gelir. kısaca: Herbokolog.",
		"Büyük silahlar, sağlam zırh ve makul fiyatlı! Kara birimlerini yok etmek için harika.",
		"Daha büyük silahlar, daha büyük zırh, daha büyük gövde, daha büyük menzil. NE VAR YÜKLE",
		"Gemilerin kralıdır. Gerçekten pahalı, ama karşılaştığı her gemiyi patlatabilir.",
		"",
		"",

		"Kısa bir süre için düşman ilerlemesini geciktirmek için, ucuz ve kolay inşa edilebilen statik surlar.",
		"Makinalı tüfekli beton siperler, piyade ilerlemesini engellemek için idealdir",
		"Kara, deniz ve hava birimlerine saldırabilme yeteneğine sahip olan Turret, şüphesiz en çok amaçlı savunma binasıdır.",
		"Kalınlaştırılmış betonun devasa bir behemothusu ve sayısız anti-hava topuyla uçakları kolaylıkla yere gömer",
		"Denize doğru yöneltilmiş 400 mm topçu deliği bataryası. Düşman gemilerini paramparça eder, ancak karada veya havada bulunan birimlere vuramaz",
		"Geniş bir alanda birimlerin kamufle özelliğini ortadan kaldırabilen, yüksek teknolojili bir alıcı kulesi.",
		"Yüksek teknoloji harikası; maliyetli ve zaman alıcı olsa da, düşmanın amına koyar.",
		"Birliklerinizin savaşabilmesi için gıda, mühimmat ve tüm malzemelerin depolandığı bir depo.",
		"",
		"",
		],
	TraitName:[
